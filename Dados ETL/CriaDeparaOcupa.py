...
Tk().withdraw()
caminho = os.getcwd()
arquivo = os.path.basename(os.getcwd() + '\\Depara_Setor.xlsx')
...
dirDestino = r'C:/Users/2102555972/Documents/Desktop/GESTAO_CD_318/Dev/Python/Python/datajoin/support_files'
...
df['EnderecoConcat'] = df['Rua'] + "-" + df['Blocagem'] + "-" + df['Nivel']
df = df.reindex(columns=['Filial', 'EnderecoConcat', 'Eqp/End', 'Setor', 'Desc_setor'])

df.to_excel(dirDestino + '/' + 'DeparaOcp.xlsx', index=False, engine='xlsxwriter')
